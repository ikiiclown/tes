...
local islandCoords = {
    ...
    ["07"] = { name = "Crater Island", position = Vector3.new(968, 1, 5100) },
...
["13"] = { name = "Lost Isle [Sisyphus]", position = Vector3.new(-3719.850830078125, -130.00000762939453, -958.6303100585938)},
